...
<body>
    ...
    <form id="form1" runat="server">
            ...
            <div class="hai">
                  <asp:DropDownList ID="DropDownList1" runat="server"  AutoPostBack="True"  OnSelectedIndexChanged="DropDownList1_SelectedIndexChanged" ForeColor="Black" ><asp:ListItem Value="">Please Select</asp:ListItem><asp:ListItem> 2</asp:ListItem><asp:ListItem> 4</asp:ListItem></asp:DropDownList><br />
            </div>
                <asp:Label ID="Label4" runat="server" Text="Vehicle Type"></asp:Label>   
            <div class="hai">
                <asp:DropDownList ID="DropDownList2" runat="server" AutoPostBack="True" OnSelectedIndexChanged="DropDownList2_SelectedIndexChanged" ForeColor="Black"></asp:DropDownList><br />
            </div>
            ...
            <asp:Label ID="Label8" runat="server" Text="Fuel Type"></asp:Label>      <asp:TextBox ID="TextBox6" runat="server"></asp:TextBox><br />
